      ...
      <div className="flex min-h-screen flex-col bg-[#FDFDFC] text-[#1b1b18]">
        ...
        <main className="flex-1">
          ...
          <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white py-24">
            ...
            {/* Glowing orbs */}
            <div className="absolute -left-20 top-20 h-72 w-72 rounded-full bg-gray-200 opacity-20 blur-3xl"></div>
            ...
            <div className="container relative mx-auto px-4">
              <div className="mx-auto max-w-4xl">
                ...
                <h1 className="mb-6 bg-gradient-to-r from-gray-700 via-gray-800 to-black bg-clip-text text-center text-5xl font-bold leading-tight tracking-tight text-transparent sm:text-6xl md:text-7xl">
                  Korfball Analytics Platform
                </h1>

                <p className="mx-auto mb-8 max-w-2xl text-center text-lg text-gray-700">
                  A powerful, data-driven platform for korfball teams to track performance, analyze statistics, and gain
                ...
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-gray-800 to-black px-6 py-3 text-base font-medium text-white shadow-lg transition-all hover:from-black hover:to-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  >
                    Get Started <ArrowRight size={18} />
                  </Link>
                  <Link
                    href="#features"
                    className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-6 py-3 text-base font-medium text-gray-700 transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  >
                    Explore Features
                  </Link>
                </div>
                ...
                <div className="absolute -right-4 bottom-0 hidden w-64 rounded-lg bg-white/80 p-4 font-mono text-xs text-gray-800 shadow-lg backdrop-blur-sm lg:block">
                  ...
                  <div>
                    <span className="text-gray-800">const</span> <span className="text-gray-600">efficiency</span> =
                    stats.<span className="text-gray-600">calculateEfficiency</span>();
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 p-1">
                  ...
                  <div className="relative h-full rounded-xl bg-white p-6">
                    ...
                    <p className="text-gray-700">
                      Monitor individual player statistics, development, and performance metrics.
                    </p>
                    <div className="mt-4 flex items-center text-gray-600">
                      <span className="text-sm font-medium">Learn more</span>
                      <ChevronRight className="ml-1 h-4 w-4" />
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 p-1">
                  ...
                  <div className="relative h-full rounded-xl bg-white p-6">
                    ...
                    <p className="text-gray-700">
                      Gain insights with detailed performance statistics and visual reports.
                    </p>
                    <div className="mt-4 flex items-center text-gray-600">
                      <span className="text-sm font-medium">Learn more</span>
                      <ChevronRight className="ml-1 h-4 w-4" />
                ...
                <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 p-1">
                  ...
                  <div className="relative h-full rounded-xl bg-white p-6">
                    ...
                    <p className="text-gray-700">
                      Record live game events with our intuitive interface designed for korfball.
                    </p>
                    <div className="mt-4 flex items-center text-gray-600">
                      <span className="text-sm font-medium">Learn more</span>
                      <ChevronRight className="ml-1 h-4 w-4" />
              ...
              <div className="grid gap-12 md:grid-cols-2 items-center">
                <div>
                  ...
                  <p className="mb-8 text-lg text-gray-700">
                    Our intuitive dashboard gives you real-time access to all the metrics that matter for your team's
                    success.
                  </p>
                ...
                <div className="relative">
                  ...
                  <div className="rounded-2xl bg-white/90 p-6 backdrop-blur-sm border border-gray-100 shadow-xl">
                    <div className="mb-6 flex items-center justify-between">
                      <h3 className="text-xl font-bold text-gray-900">Team Performance</h3>
                      <div className="rounded-lg bg-gray-50 px-3 py-1 text-sm font-medium text-gray-700">
                        Last 5 Games
                      </div>
                    </div>
                  ...
                  <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-gray-200 opacity-20 blur-2xl"></div>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid gap-8 md:grid-cols-3">
                <div className="relative">
                  ...
                  <h3 className="mb-2 text-xl font-semibold text-gray-900">Create Your Account</h3>
                        <p className="text-gray-700">Sign up for free and set up your team profile in minutes.</p>
          ...
          <section className="relative py-20 bg-gradient-to-b from-white to-gray-50">
            {/* Glowing orbs */}
            <div className="absolute left-1/4 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gray-200 opacity-20 blur-3xl"></div>
            <div className="absolute right-1/4 top-1/2 h-64 w-64 translate-x-1/2 -translate-y-1/2 rounded-full bg-gray-200 opacity-20 blur-3xl"></div>

            <div className="container relative mx-auto px-4">
              <div className="mx-auto max-w-4xl rounded-2xl border border-gray-100 bg-white/80 p-8 text-center backdrop-blur-lg shadow-xl">
                <h2 className="mb-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
